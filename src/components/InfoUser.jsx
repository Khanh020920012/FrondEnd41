...
const InfoUser = () => {
  ...
  const [avatar, setAvatar] = useState(
    `${BASE_URL_IMG}/1714398303016-468302619_cat.jpeg`
  );
  const { id } = useParams();
            ...
            <div className="col-2">
              ...
              <input
                ...
                onChange={() => {
                  ...
                  uploadAvatarAPI(lstFormData)
                    .then((result) => {
                      console.log(result);
                      setAvatar(
                        `http://localhost:8080/public/img/${result[0].filename}`
                      );
                    })
                    .catch((error) => {
                  ...
                  // formData.append("upload_preset", "j15zhq9h");
